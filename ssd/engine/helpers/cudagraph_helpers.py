...
def run_fi_tree_decode_cudagraph(model_runner, input_ids, positions, last_only, graph_vars, step, cache_hits, hidden_states=None):
    ...
    plan_args = [
        ...
        B, model_runner.hf_config.num_attention_heads // model_runner.num_tp_gpus,
        model_runner.hf_config.num_key_value_heads // model_runner.num_tp_gpus,
...
def capture_fi_tree_decode_cudagraph(model_runner):
    ...
    for bs in reversed(graph_bs_list):
        ...
        model_runner.prefill_wrappers[bs].plan(
            ...
            kv_indices,
            kv_last_page_len,
            hf_config.num_attention_heads // model_runner.num_tp_gpus,
            hf_config.num_key_value_heads // model_runner.num_tp_gpus,
            hf_config.head_dim,
